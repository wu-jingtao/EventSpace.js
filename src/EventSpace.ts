...
export default class EventSpace<T> {
    ...
    */
     ...
     */
    offDescendants(listener?: Listener<T>, clearDataWhenEmpty: boolean = true, includeSelf: boolean = true): void {
     ...
     * @param includeSelf 可以传递一个boolean来指示是否要同时清除自身的事件监听器，默认true
     */
    offAncestors(listener?: Listener<T>, clearDataWhenEmpty: boolean = true, includeSelf: boolean = true): void {
