...
export default class EventSpace<T> {
    ...
    */
     ...
     */
    cancelDescendants(listener?: Listener<T>, clearDataWhenEmpty?: boolean, includeSelf?: boolean): void;
    /**
     * 清理所有祖先上的事件监听器
     ...
     * @param includeSelf 可以传递一个boolean来指示是否要同时清除自身的事件监听器，默认true
     */
    cancelAncestors(listener?: Listener<T>, clearDataWhenEmpty?: boolean, includeSelf?: boolean): void;
    /**
     * 触发事件监听器
     * @param data 要传递的数据
